...
export const envSchema = z.object({
  ...
  AMOCRM_FIELD_STAGE_ID: z.coerce.number().int().positive().default(724372),
  AMOCRM_FIELD_PROGRESS_ID: z.coerce.number().int().positive().default(724374),
  AMOCRM_FIELD_ADMIN_COMMENT_ID: z.coerce.number().int().positive().default(724376),
